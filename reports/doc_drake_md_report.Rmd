...
```{r doc_fullcore_combined, fig.width=7, fig.height=6}
readd(gg_doc_fullcore_combined)
```

```{r doc_fullcore_combined_homo, fig.width=10, fig.height=4}
readd(gg_doc_fullcore_combined_homo)
```
