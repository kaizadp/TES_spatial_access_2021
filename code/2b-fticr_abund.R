...
relabund_cores = 
  ...
  group_by(Core, Assignment, Moisture, Wetting, Suction, Homogenization, Amendments, class) %>%       #$$$$#
...
relabund_trt = 
  relabund_cores %>% 
  group_by(Assignment, Moisture, Wetting, Suction, Homogenization, Amendments, class) %>%       #$$$$#
...
# IV. OUTPUT ----
write.csv(relabund_cores, "data/processed/fticr_relabund_cores", row.names=FALSE)
write.csv(relabund_trt, "data/processed/fticr_relabund_trt", row.names=FALSE)
